...
# Insights & Findings
•	Elbow Method: There appears to be a clear “elbow point,” indicating the ideal number of clusters.
•	Silhouette Score: Peaks around this selected number of clusters, validating segmentation quality.
•	Cluster Visualization: The customer groups are distinct and well-separated, demonstrating successful segmentation.
